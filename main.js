...
//var setOfAccumlatedData = [new structOfAccumulatedData(0, 0), new structOfAccumulatedData(0, 0), new structOfAccumulatedData(0, 0), new structOfAccumulatedData(0, 0), new structOfAccumulatedData(0, 0), new structOfAccumulatedData(0, 0)]
...
function successfulCrime(buttonIndex) {
    ...
    addToLog(setOfCrime[buttonIndex].name + "committed, " +
    ...
    console.log(buttonIndex + " " + setOfAccumlatedData[buttonIndex].numberTimesCommitted);
...
function refreshInfoPanel(buttonIndex) {
    ...
    switch (setOfCrime[buttonIndex].state) {
        ...
        case 0:
            ...
            newInfoText += generateAccumulatedDataText(buttonIndex);
            if (money >= setOfCrime[buttonIndex].cost) {
                updateGoButton("CLICK TO COMMIT");
            } else { updateGoButton("U CAN'T AFFORD IT") }
            break;
            //
...
function generateAccumulatedDataText(buttonIndex) {
    if (setOfAccumlatedData[buttonIndex].numberTimesCommitted < 1) {
        ...
        accumDataText = "<br><br>YOU'VE COMMITTED THIS CRIME <br>" +
