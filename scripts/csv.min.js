    ...
    (p.parse = function (e, r) {
      ...
      for (
        a = function (e) {
          return (
            !0 !== u &&
              ("" === e ? (e = null) : !0 === i.skipinitialspace && (e = v(e)), h.test(e) ? (e = parseInt(e, 10)) : m.test(e) && (e = parseFloat(e, 10))),
            e
          );
        },
          o = 0;
          ...
          !1 !== s || (l !== i.delimiter && l !== i.lineterminator)
            ? l !== i.quotechar
              ...
              ? e.charAt(o + 1) === i.quotechar
                ...
                : (s = !1)
              : (u = s = !0)
            : ((c = a(c)), f.push(c), l === i.lineterminator && (d.push(f), (f = [])), (c = ""), (u = !1));
    ...
    (p.serialize = function (e, r) {
      ...
      for (
        o = function (e) {
          return (
            null === e
              ...
              ? (a.doublequote && (e = e.replace(/"/g, '""')), (e = a.quotechar + e + a.quotechar))
        ...
        for (l = t[n], i = 0; i < l.length; i += 1)
          (s = o(l[i])), i === l.length - 1 ? ((c += (u += s) + a.lineterminator), (u = "")) : (u += s + a.delimiter), (s = "");
      return c;
    });
  var h = /^\d+$/,
    m = /^\d*\.\d+$|^\d+\.\d*$/,
